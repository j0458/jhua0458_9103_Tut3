...
### My code features
My code design is centered on the interaction between the mouse and keyboard. By sliding the mouse, the main visual element achieves a regular and smooth rotation effect; the outer radial lines also rotate dynamically with the change of the mouse coordinates, combined with the adjustment of line length and angle, breaking the limitations of traditional two-dimensional expression and enhancing the spatial sense and layering of the picture. In order to create an uncertain visual interest, I added randomly generated star elements in the center area. In addition, different keyboard keys can also trigger the switching of the main visual state, further enriching the interactive experience and overall layering.
